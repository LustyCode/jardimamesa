...
// Botão expandir experiência
var escondido = document.getElementById('experiencia-mostrar');

 function mostrarExp() {
   if (escondido.classList.contains('d-none')){
    escondido.classList.remove('d-none');
   }else{
    escondido.classList.add('d-none')
   }
 }
